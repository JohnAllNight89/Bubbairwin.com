...
- **Affiliations** — linked cards for [Glasshouse Tattoo](https://goodnightnashville.com/glass-house/) and [Old Town Ink](https://oldtownink.com)
- **Partners & Sponsors** — dedicated tab (`#partners`) with a featured Instagram post embed and image-forward cards for Fusion Tattoo Ink, DTF Yourself, Inker, Wheelhouse Tattoo Co., and Bubba's music project This Nvr Then
